...
class areaDataList extends StatefulWidget {
  areaDataList({Key? key}) : super(key: key);

  @override
  stateAreaDataList createState() => stateAreaDataList();
}

class stateAreaDataList extends State<areaDataList> {
