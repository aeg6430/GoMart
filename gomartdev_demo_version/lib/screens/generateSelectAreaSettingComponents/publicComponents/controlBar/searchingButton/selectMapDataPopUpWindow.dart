...
class selectMapDataPopUpWindow extends StatefulWidget {
  selectMapDataPopUpWindow({Key? key}) : super(key: key);
  ...
  @override
  stateSelectMapDataPopUpWindow createState() => stateSelectMapDataPopUpWindow();
}
...
class stateSelectMapDataPopUpWindow extends State<selectMapDataPopUpWindow> {
  List<Item> _items = [];
