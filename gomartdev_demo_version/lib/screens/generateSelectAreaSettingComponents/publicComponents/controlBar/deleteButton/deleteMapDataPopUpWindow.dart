...
class deleteMapDataPopUpWindow extends StatefulWidget {
  deleteMapDataPopUpWindow({Key? key}) : super(key: key);
  ...
  @override
  stateDeleteMapDataPopUpWindow createState() => stateDeleteMapDataPopUpWindow();
}
...
class stateDeleteMapDataPopUpWindow extends State<deleteMapDataPopUpWindow> {
  List<Item> _items = [];
