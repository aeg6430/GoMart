...
import 'filterPopUpWindow.dart';




class selectDataPopUpWindow extends StatefulWidget {
  selectDataPopUpWindow({Key? key}) : super(key: key);
  ...
  @override
  stateSelectDataPopUpWindow createState() => stateSelectDataPopUpWindow();
}
...
class stateSelectDataPopUpWindow extends State<selectDataPopUpWindow> {
  ...
  List<DataColumn> _createColumns() {
    ...
    return [
      ...
      DataColumn(
        label: const Text('modelId'),
        numeric: false,
        onSort: (int columnIndex, bool ascending) {
          if (ascending) {
            _items.sort((item1, item2) => item1.modelId.compareTo(item2.modelId));
          } else {
            _items.sort((item1, item2) => item2.modelId.compareTo(item1.modelId));
          }
          setState(() {
            _sortColumnIndex = columnIndex;
            _sortAscending = ascending;
