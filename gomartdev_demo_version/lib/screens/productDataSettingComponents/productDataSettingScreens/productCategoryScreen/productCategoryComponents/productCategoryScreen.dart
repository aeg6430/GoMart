...
class productCategoryScreen extends StatefulWidget{
  ...
  @override
  stateProductCategoryScreen createState() => stateProductCategoryScreen();
}

class stateProductCategoryScreen extends State<productCategoryScreen>{
   ...
   TextEditingController productCategoryIDTextController = TextEditingController(text: "類別編號");
   TextEditingController productCategoryNameTextController = TextEditingController(text: "類別名稱");
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                padding: EdgeInsets.symmetric(horizontal: 2),
                                                child: TextFormField(
                                                  controller: productCategoryIDTextController,
                                                  enabled: enabled,
                                                  readOnly: false,
                                                  decoration:
                                                  InputDecoration(
                                              ...
                                              Container(
                                                ...
                                                padding: EdgeInsets.symmetric(horizontal: 2),
                                                child: TextFormField(
                                                  controller: productCategoryNameTextController,
                                                  enabled: enabled,
                                                  readOnly: false,
                                                  decoration:
                                                  InputDecoration(
