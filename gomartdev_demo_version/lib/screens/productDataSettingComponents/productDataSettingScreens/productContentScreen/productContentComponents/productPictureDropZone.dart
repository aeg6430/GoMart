...
import '../../../../../globals.dart';
class productPictureDropZone extends StatefulWidget {
  const productPictureDropZone({Key? key}) : super(key: key,);

  @override
  stateProductPictureDropZone createState() => stateProductPictureDropZone();
}

class stateProductPictureDropZone extends State<productPictureDropZone>{
  ...
  Widget build(BuildContext context) {
    return Provider<stateProductPictureDropZone>(
      create:(_)=>stateProductPictureDropZone(),
      child: SafeArea(
          child: Dialog(
              elevation: 5,
