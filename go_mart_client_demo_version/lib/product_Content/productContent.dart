...
class stateProductContent extends StatefulWidget{
  const stateProductContent({ Key key}) : super(key: key);
...
class ProductContent extends State<stateProductContent> with AutomaticKeepAliveClientMixin{
  @override
                    ...
                    child: Expanded(
                      child: Query(
                        options: QueryOptions(
                            ...
                            variables: {"modelID" :globalCategoryModelID},
                                    ...
                                    children: [
                                      ...
                                      Query(
                                        options: QueryOptions(
                                            ...
                                            variables: {"brandID" :getRelatedBrandID,"modelID":getRelatedModelID},
                                            fetchPolicy: FetchPolicy.cacheAndNetwork,
                                            onError: (result){
                                              debugPrint(result?.graphqlErrors.toString());
                                              debugPrint(result?.linkException.toString());
