...
class stateCouponRedeemVerifyVerifyCodePageWidget extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    ...
    return CouponRedeemVerifyVerifyCodePageWidget();
  }
}

class CouponRedeemVerifyVerifyCodePageWidget extends State<stateCouponRedeemVerifyVerifyCodePageWidget> {
                                ...
                                child: Text('下一步', style: TextStyle(
                                  ...
                                  onPressed:() async {
                                   ...
                                   var nav = await Navigator.of(context).push(
                                        CupertinoPageRoute(
                                            builder: (context)=>stateCouponRedeemVerifyResetPasswordPageWidget()
                                        )
                                    );
                                    if(nav==true||nav==null){
                                      Navigator.of(context).pushAndRemoveUntil(
                                          CupertinoPageRoute(
                                              builder: (context)=>stateCouponRedeemVerifyForgetPasswordPageWidget()
