...
class stateCouponRedeemVerifyForgetPasswordPageWidget extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    ...
    return CouponRedeemVerifyForgetPasswordPageWidget();
  }
}



class CouponRedeemVerifyForgetPasswordPageWidget extends State<stateCouponRedeemVerifyForgetPasswordPageWidget> {
                        ...
                        child: Container(
                            ...
                            child: OutlinedButton(style: OutlinedButton.styleFrom(
                              ...
                              var nav = await Navigator.of(context).push(
                                      CupertinoPageRoute(
                                          builder: (context)=>stateCouponRedeemVerifyVerifyCodePageWidget()
                                      )
                                  );
